				...
				<div class="tz-2-com tz-2-main">
					<div class="db-list-com tz-db-table">
						<div class="invoice">
							...
							<p>Thank you,<br>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p> <a href="db-payment.php" class="waves-effect waves-light btn-large">Pay Invoice</a><a href="#!" class="waves-effect waves-light btn-large">Print</a> <a href="#!" class="waves-effect waves-light btn-large">Download PDF</a> </div>
						</div>
					</div>
				</div>
			</div>
