			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse navbar-ex1-collapse">
					...
					<?php switch(settings_item('adv.search_location')) {
								...
								case 1:?>
					<div class="hidden-xs hidden-sm btnTOP pull-left">
					<div class="btn-group">
					...
					<div class="modal fade" id="selectLocation">
						...
						<?php endif;?>
					<div class="hidden-xs hidden-sm top3 <?php echo settings_item('adv.search_location') == 2 ? 'centered-text' : 'pull-right';?>">
					<div class="btn-group">						
	...
	<div class="row-fluid">
		<div class="col-sm-3">
		  ...
		  <div class="panel-body">
			  <ul class="unstyled">
			  	<li class="small"><span class="glyphicon glyphicon-eye-open"></span><strong><?php echo lang('members_display_name');?>: </strong><?php echo $users_info->display_name;?></li>
			  	<li class="small"><span class="glyphicon glyphicon-calendar"></span><strong><?php echo lang('members_last_login');?>: </strong><?php echo $users_info->last_login;?></li>
			  	<li class="small"><span class="glyphicon glyphicon-cloud"></span><strong><?php echo lang('members_last_ip');?>: </strong><?php echo $users_info->last_ip;?></li>
			  </ul>
