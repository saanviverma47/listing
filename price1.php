...
<body>
	...
	<section class="dir-pa-sp-top dir-pa-sp-top-bg">
		<div class="rows">
			<div class="container">
				<div class="list-featu com-padd">
					<div class="col-xs-12 col-sm-6 col-md-3">
						<ul class="pricing-detail">
							<li><img src="images/logo2.png" alt=""> </li>
							<li class="p-one">Listing</li>
							<li class="p-two">Descriptions </li>
							<li class="p-one">Contact Info</li>
							<li class="p-two">Photo Gallery</li>
							<li class="p-one">Rating & Reviews</li>
							<li class="p-two">Social Media</li>
							<li class="p-one">SEO Optomization</li>
							<li class="p-two">Unlimited Listing</li>
							<li class="p-one">Listing Priority</li>
							<li class="p-two">Video Gallery</li>
							<li class="p-one">Verified Listing</li>
						</ul>
					</div>
					<div class="col-xs-12 col-sm-6 col-md-3">
						<ul class="pricing">
							<li>Basic</li>
							<li><span>10%</span>Off</li>
							<li class="p-one"><i class="fa fa-check"></i> </li>
							<li class="p-two"><i class="fa fa-check"></i> </li>
							<li class="p-one"><i class="fa fa-check"></i> </li>
							<li class="p-two"><i class="fa fa-check"></i> </li>
							<li class="p-one"><i class="fa fa-check"></i> </li>
							<li class="p-two"><i class="fa fa-times"></i> </li>
							<li class="p-one"><i class="fa fa-times"></i> </li>
							<li class="p-two"><i class="fa fa-times"></i> </li>
							<li class="p-one"><i class="fa fa-times"></i> </li>
							<li class="p-two"><i class="fa fa-times"></i> </li>
							<li class="p-one"><i class="fa fa-times"></i> </li>
							<li class="price-start"> <a class="waves-effect waves-light btn-large full-btn" href="db-listing-add.php">Get Started</a> </li>
						</ul>
					</div>
					<div class="col-xs-12 col-sm-6 col-md-3">
						<ul class="pricing p-pro">
							<li>Pro</li>
							<li><span>50%</span>Off</li>
							<li class="p-one"><i class="fa fa-check"></i> </li>
							<li class="p-two"><i class="fa fa-check"></i> </li>
							<li class="p-one"><i class="fa fa-check"></i> </li>
							<li class="p-two"><i class="fa fa-check"></i> </li>
					...
					<div class="col-xs-12 col-sm-6 col-md-3">
						<ul class="pricing p-ppro">
							<li>Pro Plus</li>
							<li><span>20%</span>Off</li>
							<li class="p-one"><i class="fa fa-check"></i> </li>
							<li class="p-two"><i class="fa fa-check"></i> </li>
							<li class="p-one"><i class="fa fa-check"></i> </li>
							<li class="p-two"><i class="fa fa-check"></i> </li>
