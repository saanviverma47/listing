                                    ...
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
										...
										?>
                                            <tr>
                                                ...
                                                <td><?=$countries->sortname?></td>
                                                <td>
													<a href="states/<?=$countries->id?>"><button type="button" class="btn waves-effect waves-light btn-rounded btn-xs btn-success">View States</button></a>
												</td>
