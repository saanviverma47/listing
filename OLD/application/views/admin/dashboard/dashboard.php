...
<head>
    ...
    <!-- MetisMenu CSS -->
    <link href="/resources/admin/metisMenu/metisMenu.min.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="/resources/admin/dist/css/sb-admin-2.css" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="/resources/admin/morrisjs/morris.css" rel="stylesheet">
...
<body>
    ...
    <script src="/resources/admin/metisMenu/metisMenu.min.js"></script>

    <!-- Morris Charts JavaScript -->
    <script src="/resources/admin/raphael/raphael.min.js"></script>
    <script src="/resources/admin/morrisjs/morris.min.js"></script>
