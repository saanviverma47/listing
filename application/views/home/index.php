		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6">
					<a href="list-lead.php">
						<div class="list-mig-like-com">
							<div class="list-mig-lc-img"> <img src="<?php echo Template::theme_url("images/listing/home.jpg")?>" alt="" /> </div>
				...
				<div class="col-md-3">
					<a href="list-lead.php">
						<div class="list-mig-like-com">
							<div class="list-mig-lc-img"> <img src="<?php echo Template::theme_url("images/listing/home2.jpg")?>" alt="" /> </div>
				...
				<div class="col-md-3">
					<a href="list-lead.php">
						<div class="list-mig-like-com">
							<div class="list-mig-lc-img"> <img src="<?php echo Template::theme_url("images/listing/home3.jpg")?>" alt="" /> </div>
							<div class="list-mig-lc-con list-mig-lc-con2">
								<h5>Australia</h5>
				...
				<div class="col-md-3">
					<a href="list-lead.php">
						<div class="list-mig-like-com">
							<div class="list-mig-lc-img"> <img src="<?php echo Template::theme_url("images/listing/home4.jpg")?>" alt="" /> </div>
							<div class="list-mig-lc-con list-mig-lc-con2">
								<h5>Germany</h5>
				...
				<div class="col-md-3">
					<a href="list-lead.php">
						<div class="list-mig-like-com">
							<div class="list-mig-lc-img"> <img src="<?php echo Template::theme_url("images/listing/home1.jpg")?>" alt="" /> </div>
							<div class="list-mig-lc-con list-mig-lc-con2">
								<h5>India</h5>
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="hom-cre-acc-left">
						...
						<ul>
							<li> <img src="<?php echo Template::theme_url("images/icon/7.png")?>" alt="">
								<div>
							...
							<li> <img src="<?php echo Template::theme_url("images/icon/5.png")?>" alt="">
								<div>
									<h5>Advertising Your Business</h5>
									<p>Advertising your business to area specific has many advantages. For local businessmen, it is an opportunity..</p>
								</div>
							</li>
							<li> <img src="<?php echo Template::theme_url("images/icon/6.png")?>" alt="">
								<div>
