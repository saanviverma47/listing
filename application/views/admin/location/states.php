            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">States of <?=$countryName?></h4>
                                ...
                                <div class="table m-t-40">
                                    <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
										...
										<?php 
											if(!empty($states)){
												foreach($states as $index=>$states):
										?>
                                            <tr>
                                                <td><?=$index+1?></td>
                                                <td><?=$states->name?></td>
                                                <td>
													<a href="/admin/location/cities/<?=$states->id?>"><button type="button" class="btn waves-effect waves-light btn-rounded btn-xs btn-success">View City</button></a>
												</td>
                                                <td><input type="checkbox" class='changeStatus' <?=$states->status == 1?'checked':''?> data-size="mini" /></td>
                                            </tr>
                                        <?php 
												endforeach;
											}
