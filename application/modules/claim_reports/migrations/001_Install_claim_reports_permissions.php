...
class Migration_Install_claim_reports_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Claim_Reports.Reports.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Claim_Reports.Reports.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Claim_Reports.Reports.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Claim_Reports.Reports.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
