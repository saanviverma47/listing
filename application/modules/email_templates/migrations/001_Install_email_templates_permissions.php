...
class Migration_Install_email_templates_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Email_Templates.Settings.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Email_Templates.Settings.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Email_Templates.Settings.Edit',
			'description' => '',
			'status' => 'active',
		),
	);
