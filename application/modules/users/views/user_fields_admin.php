...
<div class="control-group<?php echo form_error('mobile_number') ? $errorClass : ''; ?>">
    <label class="control-label" for="mobile_number"><?php echo lang('label_mobile_number'); ?></label>
    <div class="controls">
        <input class="<?php echo $controlClass; ?>" type="text" id="mobile_number" name="mobile_number" value="<?php echo set_value('mobile_number', isset($user) ? $user->mobile_number : ''); ?>" />
