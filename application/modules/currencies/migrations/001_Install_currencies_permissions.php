...
class Migration_Install_currencies_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Currencies.Settings.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Currencies.Settings.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Currencies.Settings.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Currencies.Settings.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
