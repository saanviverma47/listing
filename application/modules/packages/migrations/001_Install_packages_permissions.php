...
class Migration_Install_packages_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Packages.Financial.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Packages.Financial.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Packages.Financial.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Packages.Financial.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
