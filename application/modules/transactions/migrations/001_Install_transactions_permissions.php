...
class Migration_Install_transactions_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Transactions.Financial.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Transactions.Financial.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Transactions.Financial.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Transactions.Financial.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
