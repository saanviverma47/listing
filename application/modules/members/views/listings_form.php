...
<div
	class="form-group <?php echo form_error('title') ? 'error' : ''; ?>">
				...
				<div class="col-sm-9">
		<input id='listings_title' class='form-control' type='text'
			name='listings_title'
...
<div class="form-group">
		...
		<option value=""><?php echo lang('placeholder_category');?></option>
			...
			<?php echo (isset($parent_category) && ($category->id == $parent_category)) ? 'selected': ''; ?>><?php echo $category->name;?></option>
			     	<?php endforeach; ?>
				</select>
</div>
...
<div class="form-group">
				...
				<select name="listings_subcategory_id" id="listings_subcategory_id"
		class="col-sm-9"
		placeholder="<?php echo lang('placeholder_subcategory');?>">
		<option value=""><?php echo lang('placeholder_subcategory');?></option>
					<?php if(!empty($sub_categories)):?>
					<?php foreach($sub_categories as $subcategory): ?>
			    			<option value="<?php echo $subcategory->id;?>"
							<?php echo isset($sub_category) && ($subcategory->id == $sub_category) ? 'selected': ''; ?>><?php echo $subcategory->name;?></option>
			     	<?php endforeach; ?>
			     	<?php endif;?>
				</select>
</div>
...
<div class="form-group">
		...
		id="listings_subsubcategory_id" class="col-sm-9"
		placeholder="<?php echo lang('placeholder_subsubcategory');?>">
		<option value=""><?php echo lang('placeholder_subsubcategory');?></option>
					<?php if(!empty($subsub_categories)):?>
					<?php foreach($subsub_categories as $subsubcategory): ?>
			    			<option value="<?php echo $subsubcategory->id;?>"
							<?php echo isset($subsub_category) && ($subsubcategory->id == $subsub_category) ? 'selected': ''; ?>><?php echo $subsubcategory->name;?></option>
			     	<?php endforeach; ?>
			     	<?php endif;?>
				</select>
</div>
...
<div class="form-group">
		...
		<option value=""><?php echo lang('placeholder_country');?></option>
					<?php if(!empty($all_countries)):?>
					<?php foreach($all_countries as $country): ?>
			    			<option value="<?php echo $country->iso;?>"
			<?php echo ((isset($listings['country_iso']) && ($country->iso == $listings['country_iso'])) || ((isset($selected_country)) && ($country->iso == $selected_country))) ? 'selected': ''; ?>><?php echo ucwords(strtolower($country->name));?></option>
			     	<?php endforeach; ?>
			     	<?php endif;?>
				</select>
</div>
...
<div class="form-group">
				...
				<select name="listings_state_id" id="listings_state_id"
		class="col-sm-9" placeholder="<?php echo lang('placeholder_state');?>">
		<option value=""><?php echo lang('placeholder_state');?></option>
					<?php if(!empty($listing_states)):?>
					<?php foreach($listing_states as $state): ?>
			    		<option value="<?php echo $state->id;?>"
						<?php echo ((isset($listings['state_id']) && ($state->id == $listings['state_id'])) || ((isset($selected_state)) && ($state->id == $selected_state))) ? 'selected': ''; ?>><?php echo $state->name;?></option>
			     	<?php endforeach; ?>
			     	<?php endif;?>
				</select>
</div>
...
<div class="form-group">
				...
				<select name="listings_city_id" id="listings_city_id"
		class="col-sm-9" placeholder="<?php echo lang('placeholder_city');?>">
		<option value=""><?php echo lang('placeholder_city');?></option>
					<?php if(!empty($listing_cities)):?>
					<?php foreach($listing_cities as $city): ?>
			    			<option value="<?php echo $city->id;?>"
			<?php echo ((isset($listings['city_id']) && ($city->id == $listings['city_id'])) || ((isset($selected_city)) && ($city->id == $selected_city))) ? 'selected': ''; ?>><?php echo $city->name;?></option>
			     	<?php endforeach; ?>
			     	<?php endif;?>
				</select>
</div>
...
<div
	class="form-group <?php echo form_error('contact_person') ? 'error' : ''; ?>">
		...
		<span class='help-block'><?php echo form_error('contact_person'); ?></span>
	</div>
</div>
...
<div class="form-group">
				...
				<select name="payment_gateways" id="payment_gateways"
		class="col-sm-9"
		placeholder="<?php echo lang('placeholder_payment_gateway');?>">
					<?php foreach($payment_gateways as $payment_gateway): ?>
			    			<option
			value="<?php echo strtolower($payment_gateway->name);?>"><?php echo ucwords(strtolower($payment_gateway->display_name));?></option>
			     	<?php endforeach; ?>
				</select>
</div>
<?php endif;?>
	...
	<div class="col-sm-6 col-sm-offset-6 controls">
		<input type="submit" name="save" class="btn btn-primary"
			value="<?php echo lang('action_save'); ?>" />
				...
				<?php if ($this->auth->restrict() && $id) : ?>or
