...
class Migration_Install_listings_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Listings.Content.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Listings.Content.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Listings.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Listings.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
