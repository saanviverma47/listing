...
<?php endif; ?>
<div class="admin-box">
	<?php echo form_open($this->uri->uri_string(), array('class' => "form-horizontal", 'id' => 'businss_hours_form')); ?>
			...
			?>
				<tr>				
					<td>
						...
						<span class='help-inline'><?php echo form_error('day_of_week'); ?></span>
					</td>
					<td><?php echo lang('label_monday');?>
					</td>
					<td>
				...
				<tr>
					<td>&nbsp;</td>
					<td><input type="submit" name="save" class="btn btn-primary" value="<?php echo lang('action_save') ?>" /></td>
					<td>&nbsp;</td><td>&nbsp;</td>
				</tr>
			</tbody>
		</table>
