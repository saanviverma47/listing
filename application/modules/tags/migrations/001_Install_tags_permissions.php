...
class Migration_Install_tags_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Tags.Content.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Tags.Content.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Tags.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Tags.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
