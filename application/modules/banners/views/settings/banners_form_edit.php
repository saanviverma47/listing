...
<div class="admin-box">
	<?php echo form_open_multipart($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
			...
			<?php echo form_hidden('banners_type', $banner_type); //banner type value?>
			<?php echo form_hidden('banners_type_id', $banners['type_id']); //banner type value?>
			<?php // Change the values in this array to populate your dropdown as required
				//if(!isset($banner_types)) {
				$options = array(
						'' => lang('label_select'),
				);
				...
				$js = 'class="span6" disabled';
				echo form_dropdown('banners_type_id', $options, set_value('banners_type_id', isset($banners['type_id']) ? $banners['type_id'] : ''), lang('label_banner_type'). lang('bf_form_label_required'), $js);
			?>
			...
			<?php if(($banner_type == 'image') || ($banner_location == 'slider')):?>
			...
			<div class="control-group <?php echo form_error('image') ? 'error' : ''; ?>">
				...
				<div class='controls'>
					...
					<a rel="gallery" href="<?php echo base_url("assets/images/banners/" . $banners['image']);?>" class="iframe-img">
						<img class="fileupload-preview fileupload-exists thumbnail admin-thumb" src="<?php echo base_url("assets/images/banners/" . $banners['image']);?>">
					</a>
					<?php endif;?>
				</div>
			</div>
			...
			<?php if(($banner_type == 'text') || ($banner_type == 'html') || ($banner_location == 'slider')): ?>
			<!-- html-text fields -->
			...
			<?php echo form_hidden('on_post_selected_locations', '', 'on_post_selected_locations'); ?>
			...
			<?php echo form_hidden('on_post_selected_categories', '', 'on_post_selected_categories'); ?>
