...
class Migration_Install_contact_queries_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Contact_Queries.Reports.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Contact_Queries.Reports.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Contact_Queries.Reports.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Contact_Queries.Reports.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
