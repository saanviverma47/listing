...
class Image_moo
{
	...
	/**
	 * Methods with the same name as their class are not constructors in PHP v7
	 * They cannot have the same as the class name, therefore,
	 * Image_moo changed to Image_mooo
	 */
