		...
		<div class="tz">
			...
			<div class="tz-l">
				...
				<div class="tz-l-2">
					<ul>
						...
						<li>
							<a href="db-all-listing.php" class="tz-lma"><img src="images/icon/dbl2.png" alt="" /> All Listing</a>
						</li>
						<li>
			...
			<div class="tz-2">
				<div class="tz-2-com tz-2-main">
					<h4>Update Listings Information</h4>
					<div class="db-list-com tz-db-table">
						<div class="ds-boar-title">
							<h2>Listings Full Information</h2>
						...
						<div class="hom-cre-acc-left hom-cre-acc-right">
							<div class="">
								<form class="">
									...
									<div class="row">
										<div class="input-field col s12 v2-mar-top-40"> <a class="waves-effect waves-light btn-large full-btn" href="#!">Submit Listing</a> </div>
									</div>
								</form>
							</div>
						</div>
